...
from qooty.team_selection import RosterData, validate_name_characters
...
class Team:
    ...
    def validate(self):
        ...
        validate_name_characters(self.name, "Team name")
        ...
        for player in self.players:
            ...
            validate_name_characters(player.name, f"Player at {player.position}")
